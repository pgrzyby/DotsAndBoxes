 ...
 * computer's move by calling the minimax algorithm with ALPHA-BETA PRUNING.
...
public class ABClient {
	   ...
	   public static void main(String[] args){
	    ...
	    System.out.println("Welcome to the Dots and Boards Game!");
	    System.out.println("Enter dimension of board: "); 
	    size=scan.nextInt();
	    System.out.println("Enter number of plies for minimax search (with alpha beta pruning!):");
	    plies= scan.nextInt();
